...
*	the Python script. It calls the script using an "exec()" method, which is usually blocked by webhost. You
*	can put the Python script into a cron job to workaround this issue.
*	
...
*	It then generates the XML saving it locally, and optionnaly, uploading it to a remote FTP server.
*	
*	As stated earlier, this Python script could be put in a cron job, but it could also be running locally on a
...
*
*	This script is provided as is and the author cannot be held responsible for any damage or misbehavior. 
*
* 	Extra notes: 
...
/		Is was mostly a learning process for me to get to know more about socket and TCP communication between server.
*/
